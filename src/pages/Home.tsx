      ...
      <main className="flex-grow relative z-10">
        ...
        <section id="services" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="glass-panel glass-panel-hover rounded-2xl relative overflow-hidden group flex flex-col">
              <div className="h-32 w-full relative overflow-hidden bg-amber-50 flex items-center justify-center border-b border-amber-100">
            ...
            <div className="glass-panel glass-panel-hover rounded-2xl relative overflow-hidden group flex flex-col">
              <div className="h-32 w-full relative overflow-hidden bg-emerald-50 flex items-center justify-center border-b border-emerald-100">
